 ...
 */
class LeadershipSkillStrategy implements SkillStrategy{

    private static Skill SKILL = Skill.LEADERSHIP
    ...
    List<Member> determinePlacesWithMembers(List<Member> members) {
        Collections.sort(members,Collections.reverseOrder(new Comparator<Member>() {
            ...
            int compare(Member o1, Member o2) {
                def o1DiplomatVal = o1.sumSkills(SKILL,Skill.LITERACY,Skill.DIPLOMACY)
                def o2DiplomatVal = o2.sumSkills(SKILL,Skill.LITERACY,Skill.DIPLOMACY)
    ...
    List<House> determinePlacesWithHouses(List<House> houses) {
        Collections.sort(houses,Collections.reverseOrder(new Comparator<House>() {
            ...
            int compare(House o1, House o2) {
                def o1DiplomacyVal = o1.overallAbility(SKILL,Skill.LITERACY,Skill.DIPLOMACY)
                def o2DiplomacyVal = o2.overallAbility(SKILL,Skill.LITERACY,Skill.DIPLOMACY)
